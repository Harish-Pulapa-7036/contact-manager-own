...
export const  Provider = (props) => {
  ...
  const userSignIn = (loginData) => {
    axios
      .post("http://localhost:6500/login", loginData)
      .then((res) => {
  ...
  const userSignUp = (userData) => {
    try {
      axios
        .post("http://localhost:6500/register", userData)
        .then((res) => {
          nav("/");
          window.alert("Registration Successful");
        })
  ...
  const postcontacts = async (contactdata) => {
    ...
    return await axios
      .post("http://localhost:6500/api/v1/contacts",contactdata,config)
  ...
  const fetchContacts = () => {
    axios
      .get("http://localhost:6500/api/v1/contacts",config)
      .then((res) => {
  ...
  const deletecontacts=(id)=>{
    axios
      .delete(`http://localhost:6500/api/v1/contacts/${id}`,config)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => console.log(err))
